...
#define TIPS_BEEP_SET(a)	GPIO_OUTPUT_SET(GPIO_ID_PIN(12), a)
#define GPIO_PIN_BEEP		GPIO_ID_PIN(12)

#else

#define ZIGB_HARDWARE_RESET_LEVEL	1
#define ZIGB_HARDWARE_NORMAL_LEVEL	0
...
#define TIPS_BEEP_SET(a)	GPIO_OUTPUT_SET(GPIO_ID_PIN(15), a)
#define GPIO_PIN_BEEP		GPIO_ID_PIN(15)
